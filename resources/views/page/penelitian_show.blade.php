...
@section('container')
 	<div class="container justify-content-center pt-5" style="max-width: 900;">
		<div class="row justify-content-center">
			<div class="col-md-8 content-rounded me-md-3">
				<div class="">
					<span class="">
					...
					<span class="mx-2">
						Category : <a href="{{ $url.'?category='.$penelitian->category }}">{{ $penelitian->category }}</a>
					</span>
				</div>
				<div class="mt-2">
					...
					<div class="">
						<div class="">
							{{ $penelitian->nama }} | {{ $penelitian->tahun }}
						</div>
						{{-- <div class="">
							{{ $penelitian->tahun }}
						</div> --}}
			...
			<hr class="d-md-none m-3 divider">
			<div class="col-md-3 content-rounded">
				<div class="widget">
