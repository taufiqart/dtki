			...
			<div class="mb-3 card rounded">
				<div class="p-3">
					...
					<div class="mb-2">
						...
						<input class="form-control @error('nama') is-invalid @enderror" type="text" id="nama" name="nama" value="{{ old('nama')}}" required @error('nama') autofocus @enderror }}>
						@error('nama')
						<div class="invalid-feedback">
							{{ $message }}
						</div>
					...
					<div class="mb-2">
						...
						<input class="form-control @error('nip') is-invalid @enderror" type="text" id="nip" name="nip" value="{{ old('nip')}}" required @error('nip') autofocus @enderror>
						@error('nip')
						<div class="invalid-feedback">
							{{ $message }}
						</div>
					...
					<div class="mb-2">
						...
						<input class="form-control @error('email') is-invalid @enderror" type="email" id="email" name="email" value="{{ old('email') }} " @error('email') autofocus @enderror>
						@error('email')
						<div class="invalid-feedback">
							{{ $message }}
						</div>
					...
					<div class="mb-2">
						...
						<input class="form-control @error('jabatan') is-invalid @enderror" type="text" id="jabatan" name="jabatan" value="{{ old('jabatan') }} " @error('jabatan') autofocus @enderror>
						@error('jabatan')
						<div class="invalid-feedback">
							{{ $message }}
						</div>
